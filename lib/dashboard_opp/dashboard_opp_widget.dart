...
class DashboardOppWidget extends StatefulWidget {
  const DashboardOppWidget({Key? key}) : super(key: key);

  @override
  _DashboardOppWidgetState createState() => _DashboardOppWidgetState();
}

class _DashboardOppWidgetState extends State<DashboardOppWidget> {
                                                  ...
                                                  return Column(
                                                    ...
                                                    children: List.generate(
                                                        columnOpportunitiesRecordList
                                                            .length,
                                                        (columnIndex) {
                                                      final columnOpportunitiesRecord =
                                                          columnOpportunitiesRecordList[
                                                              columnIndex];
                                                      return Padding(
                                                        padding:
