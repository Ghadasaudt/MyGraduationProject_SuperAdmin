...
class CoueseInfoWidget extends StatefulWidget {
  const CoueseInfoWidget({
    Key? key,
    this.courseid,
  }) : super(key: key);
  ...
  @override
  _CoueseInfoWidgetState createState() => _CoueseInfoWidgetState();
}

class _CoueseInfoWidgetState extends State<CoueseInfoWidget> {
