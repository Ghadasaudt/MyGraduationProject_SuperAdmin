...
class AddActivityCopyWidget extends StatefulWidget {
  const AddActivityCopyWidget({Key? key}) : super(key: key);

  @override
  _AddActivityCopyWidgetState createState() => _AddActivityCopyWidgetState();
}

class _AddActivityCopyWidgetState extends State<AddActivityCopyWidget> {
